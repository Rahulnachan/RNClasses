...
const WhyCourses = () => {
  ...
  // List of reasons why students should take courses
  const reasons = [
    {
    ...
    },
    {
      icon: ChartBarIcon,
      title: 'Career Growth',
      description: '82% of our students report career advancement within 6 months.',
      color: 'green'
    },
    {
      icon: UserGroupIcon,
      title: 'Community Support',
      description: 'Join a network of 50,000+ learners and industry experts.',
      color: 'purple'
    },
    {
      icon: ClockIcon,
    ...
    },
    {
      ...
      description: 'Practical, hands-on projects that build your portfolio.',
      color: 'red'
    },
    {
      icon: GlobeAltIcon,
  ...
  // Colors used for gradient background of icons
  const colorClasses = {
          ...
          {reasons.map((reason, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon Section */}
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${colorClasses[reason.color]} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
